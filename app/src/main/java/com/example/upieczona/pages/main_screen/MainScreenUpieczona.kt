...
fun MainScreenUpieczona(
  ...
  val allPostsFromCategories = upieczonaAPIViewModel.allCategoryPosts.collectAsState()
  val allPosts = upieczonaAPIViewModel.allPosts.collectAsState()
  ...
  if (isLoading) {
    ...
    if (categoriesState.isEmpty()) {
      ...
      LazyGridOfPosts(
        allPosts = allPosts, scrollState = scrollState, navController = navController, paddingValues
      )
    }
  }
}
